...
<body>
	<div class="row main_title">
		<div class="col">
			<span class="text_orange">추천</span>
		...
		<div class="modal-dialog modal-md modal-dialog-centered" role="document">
			<div class="modal-content">
				...
				<div class="modal-body modal_text" style="text-align: center;">
					<span class="text_blue">추천 팀은 회원님이 입력하신</span><br>
					<span class="text_orange">지역, 관심 분야, 보유 기술, 역할</span><span class="text_blue"> 등에 따라<br>
					자동으로 추천되는 팀입니다.<br>
					더욱 정확한 추천을 위해</span><span class="text_orange"> 프로필을 업데이트 해보세요!</span>
				</div>
			</div>
		</div>
	</div>
	...
	<c:if test="${not empty recommendedTeamList }">
		<c:forEach items="${recommendedTeamList }" var="recommendedTeam" varStatus="status">
				...
				<div class="col-xs-6 main_content_row" onclick="$('#recommendTeamForm${recommendedTeam.teamId }').submit();">
					<div class="row main_content">
						...
						<div class="col-xs-6 main_content_text">
							...
							<div class="row main_text">
								<label class="text-truncate main_text main_text_team_name">일치율: ${fn:substring(recommendedTeam.rate, 0, 2) }%</label>
							</div>
						</div>
					</div>
				</div>
