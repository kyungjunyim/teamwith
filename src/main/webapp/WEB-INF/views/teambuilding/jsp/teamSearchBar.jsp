								...
								<c:forEach items="${applicationScope.regionList }" var="regions"
									...
									<div class="col" style="margin-left: 20px;">
										<input type="checkbox"
											...
											id="${regions.key }" value="${regions.value }">${regions.value }
									</div>
					...
					<div class="modal-content">
						...
						<div class="modal-body modal_text">
							<c:forEach items="${applicationScope.projectList }"
								...
								<div class="col" style="margin-left: 20px;">
									<input type="checkbox" class="form-check-input modal_check_box" name="project"
										id="${projects.key }" value="${projects.value }">${projects.value }
								</div>
								<c:if test="${status.index % 3 == 2 }">
						</div>
						</c:if>
					...
					<div class="modal-content">
						...
						<div class="modal-body modal_text">
							<c:forEach items="${applicationScope.roleList }" var="roles"
								...
								<div class="col" style="margin-left: 20px;">
									<input type="checkbox" class="form-check-input modal_check_box" name="role"
										id="${roles.key }" value="${roles.value }">${roles.value }
								</div>
								<c:if test="${status.index % 2 != 0 }">
						</div>
						</c:if>
