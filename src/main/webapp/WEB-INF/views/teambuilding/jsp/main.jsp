				...
				<form action="/account/register" method="post">
					...
					<div class="modal-body">
						<label class="register_label">아이디</label> <input type="text"
							placeholder="아이디" id="id" class="register_input" name="memberId" required><br>
						<label class="register_label">비밀번호</label> <input type="password"
							id="pwd" placeholder="비밀번호" class="register_input"
							name="memberPassword" required><br> <label
							class="register_label">비밀번호 확인</label> <input type="password"
							id="pwd2" placeholder="비밀번호 확인" class="register_input" required><br>
						<label class="register_label">이름</label> <input type="text"
