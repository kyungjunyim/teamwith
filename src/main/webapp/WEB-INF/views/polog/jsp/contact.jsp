...
<link rel="stylesheet" type="text/css"
	href="/resources/polog/css/contact.css">
<style>
@font-face {
	...
	<div id="contact" class="section scrollspy">
		...
		<div class="card medium">
			<div class="card-image waves-effect waves-block waves-light">
				<img id="contact_img" class="activator"
					src="/resources/image/contact.png">
			</div>
			...
			<div class="card-reveal">
				...
				<form class="col s12" action="https://formspree.io/a@gmail.com"
