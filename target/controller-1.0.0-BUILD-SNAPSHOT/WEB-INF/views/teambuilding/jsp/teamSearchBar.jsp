...
<body>
	<form action="/teamSearch" method="post" id="teamSearch">
		<div class="row search_bar_row">
			<div class="member_search_btn_padding">
				...
				<button type="button"
					...
					data-toggle="modal" data-target="#regionModal" id="regionBtn"
					style="color: red;">활동 지역 0</button>
				<div class="modal fade bd-example-modal-sm" id="regionModal"
					tabindex="-1" role="dialog"
					aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
					<div class="modal-dialog modal-dialog-centered" role="document">
						<div class="modal-content">
							<div class="modal-header">
								<h5 class="modal-title text_orange" id="exampleModalLongTitle">활동
									지역</h5>
							</div>
							<div class="modal-body modal_text">
								<c:forEach items="${applicationScope.regionList }" var="regions"
									varStatus="status">
									...
									<div class="col" style="margin-left: 20px;">
										<input type="checkbox"
											class="form-check-input modal_check_box" name="region"
											id="${regions.key }" value="${regions.key }">${regions.value }
									</div>
		...
		<div class="member_search_btn_padding">
			...
			<button type="button"
				class="btn btn-md member_search_btn_color member_search_btn_size"
				data-toggle="modal" data-target="#projectModal" id="projectBtn"
				style="color: red;">관심 분야 0</button>
			<div class="modal fade bd-example-modal-sm" id="projectModal"
				tabindex="-1" role="dialog"
				aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
				<div class="modal-dialog modal-dialog-centered modal-lg"
					...
					<div class="modal-content">
						<div class="modal-header">
							<h5 class="modal-title text_orange" id="exampleModalLongTitle">관심
								분야</h5>
						</div>
						<div class="modal-body modal_text">
							<c:forEach items="${applicationScope.projectList }"
								var="projects" varStatus="status">
								<c:if test="${status.index % 3 == 0 }">
									<div class="row">
								</c:if>
								<div class="col" style="margin-left: 20px;">
									<input type="checkbox" class="form-check-input modal_check_box"
										name="project" id="${projects.key }" value="${projects.key }">
									${projects.value }
								</div>
								<c:if test="${status.index % 3 == 2 }">
						</div>
		...
		<div class="member_search_btn_padding">
			...
			<button type="button"
				class="btn btn-md member_search_btn_color member_search_btn_size"
				data-toggle="modal" data-target="#roleModal" id="roleBtn"
				style="color: red;">역할 0</button>
			<div class="modal fade bd-example-modal-sm" id="roleModal"
				tabindex="-1" role="dialog"
				aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
				<div class="modal-dialog modal-dialog-centered" role="document">
					<div class="modal-content">
						...
						<div class="modal-body modal_text">
							<c:forEach items="${applicationScope.roleList }" var="roles"
								varStatus="status">
								...
								<div class="col" style="margin-left: 20px;">
									<input type="checkbox" class="form-check-input modal_check_box"
										name="role" id="${roles.key }" value="${roles.key }">
									${roles.value }
								</div>
								<c:if test="${status.index % 2 != 0 }">
						</div>
		...
		<div class="member_search_btn_padding">
			<button type="button"
				class="btn btn-md member_search_btn_color member_search_btn_size"
				data-toggle="modal" data-target="#skillModal" id="skillBtn"
				style="color: red;">보유 기술 0</button>
					...
					<div class="modal-content">
						...
						<div class="modal-body modal_text">
							<c:forEach items="${applicationScope.developerSkillList }"
								...
								<div class="col" style="margin-left: 20px;">
									<input type="checkbox" class="form-check-input modal_check_box"
										name="skill" id="${skills.key }" value="${skills.key }">
									${skills.value }
								</div>
								<c:if test="${status.index % 3 == 2 }">
						</div>
		...
		<div class="modal-body modal_text">
			<c:forEach items="${applicationScope.plannerSkillList }" var="skills"
				...
				<div class="col" style="margin-left: 20px;">
					<input type="checkbox" class="form-check-input modal_check_box"
						name="skill" id="${skills.key }" value="${skills.value }">${skills.key }
				</div>
				<c:if test="${status.index % 3 == 2 }">
		</div>
		</c:if>
		...
		<div class="member_search_btn_size_big">
			...
			</select> <input class="member_search_input_box" type="text" name="keyword">
